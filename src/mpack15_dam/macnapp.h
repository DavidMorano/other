...
typedef short (*na_curp)(struct na_win *, Point);
...
typedef struct na_win {
	...
	na_curp		cursorp;	/* cursor setting proc */
...
#define NA_CURON		0x00004000L	/* true if application has set the cursor */
